        ...
        for layer_set in config["layers"]:
            ...
            for comparison in layer_set["comparison"]:
                ...
                for batch_size in config["batch_sizes"]:
                    ...
                    print(f"Mean runtime across {config['num_repeats']} runs for batch_size {batch_size}:")
                    print(results, "\n")

                    print(f"Standard deviation across {config['num_repeats']} runs for batch_size {batch_size}:")
                    print(std, "\n")
